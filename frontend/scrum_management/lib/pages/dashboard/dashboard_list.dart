...
import 'package:scrum_management/pages/dashboard/stats_pie.dart';
import 'package:scrum_management/pages/dashboard/stats_table.dart';
...
class DashboardStats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<scrum_management.User> users = [];
    Map<Int64, int> usersMap = {};
    if (dashboardNameShort == 'Proyectos') {
      usersMap = cardProvider
          .getCardsByUserWithCategory(scrum_management.CardCategory.Proyectos);
      users = userProvider.get5NamesWithMoreCards(usersMap);
    }
    if (dashboardNameShort == 'Roadmap') {
      usersMap = cardProvider
          .getCardsByUserWithCategory(scrum_management.CardCategory.Roadmap);
      users = userProvider.get5NamesWithMoreCards(usersMap);
    }
