...
class CommentsBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<scrum_management.Comment> comments =
...
class WriteCommentBox extends StatelessWidget {
  final scrum_management.Card cardToComment;
  final int? parent;
  final Function callback;
  ...
  Widget build(BuildContext context) {
    ...
    void _saveComment() {
      ...
      scrum_management.Comment newComment = scrum_management.Comment(
        id: Int64(numId),
...
class CommentItemWidget extends StatelessWidget {
  final scrum_management.Comment comment;
  final Function callback;
  ...
  Widget build(BuildContext context) {
    ...
    List<scrum_management.Comment>? childComments = commentsProvider.comments
