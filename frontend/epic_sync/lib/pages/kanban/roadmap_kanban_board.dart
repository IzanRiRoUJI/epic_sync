...
class RoadmapKanbanBoard extends StatelessWidget {
  const RoadmapKanbanBoard({Key? key}) : super(key: key);
                      ...
                      child: Row(
                        children: [
                          const MediumCardList(
                              state: epic_sync.CardState.Pendiente, s: 'R'),
                          VerticalDivider(
                            color:
                          ...
                          const MediumCardList(
                              state: epic_sync.CardState.Proceso, s: 'R'),
                          VerticalDivider(
                            color:
                                Provider.of<ThemeProvider>(context).accentColor,
                            thickness: 1,
                          ...
                          const MediumCardList(
                              state: epic_sync.CardState.Revisar, s: 'R'),
                          VerticalDivider(
                            color:
                                Provider.of<ThemeProvider>(context).accentColor,
                            thickness: 1,
                          ...
                          const MediumCardList(
                              state: epic_sync.CardState.Listo, s: 'R'),
                        ],
                      ),
                    ),
                  ],
