...
class ProyectsKanbanBoard extends StatelessWidget {
  const ProyectsKanbanBoard({Key? key}) : super(key: key);
                      ...
                      child: Row(
                        children: [
                          const MediumCardList(
                              state: epic_sync.CardState.Pendiente, s: 'P'),
                          VerticalDivider(
                            color:
                          ...
                          const MediumCardList(
                              state: epic_sync.CardState.Proceso, s: 'P'),
                          VerticalDivider(
                            color:
                                Provider.of<ThemeProvider>(context).accentColor,
                            thickness: 1,
                          ...
                          const MediumCardList(
                              state: epic_sync.CardState.Revisar, s: 'P'),
                          VerticalDivider(
                            color:
                                Provider.of<ThemeProvider>(context).accentColor,
                            thickness: 1,
                          ...
                          const MediumCardList(
                              state: epic_sync.CardState.Listo, s: 'P'),
                        ],
                      ),
                    ),
                  ],
